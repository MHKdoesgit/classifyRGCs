...
function plotPCAsApp(app, state)
...
switch lower(state)
    case 'new'
        ...
        for ii = 1:3
            ...
            plot(pcaplt, dat.pcadata.scores(:,ii), dat.rf.RFdiameter,'o', 'MarkerFaceColor' ,0.65.*[1 1 1],'Color',0.85*[1 1 1]);
            hold(pcaplt,'on');
            plot(pcaplt, dat.pcadata.scores(curridx,ii), dat.rf.RFdiameter(curridx),'o', 'MarkerFaceColor' ,col,...
                'Color',[0.85 0.078 0.24],'MarkerSize',8);
